...
import 'package:gezabeautyexpertapp/screens/add_new_coupon_screen.dart';
import 'package:gezabeautyexpertapp/widgets/bg_image_widget.dart';
import 'package:gezabeautyexpertapp/data/coupon.dart';
      ...
      children: [
        GestureDetector(
          child: Container(
            ...
            child: Center(
              child: Text(
                '${Strings.addNewCoupon.toUpperCase()} +',
                style: TextStyle(
                    color: Colors.white,
        ...
        SizedBox(
          ...
          child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                Coupon coupon = CouponList.list()[index];
                return Padding(
                  padding: const EdgeInsets.only(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text('Added ${coupon.time} month ago',
