...
import 'package:gezabeautyexpertapp/screens/add_new_offer_screen.dart';
      ...
      children: [
        GestureDetector(
          child: Container(
            ...
            child: Center(
              child: Text(
                '${Strings.addNewOffer.toUpperCase()} +',
                style: TextStyle(
                    color: Colors.white,
          ...
          onTap: () {
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => const AddNewOfferScreen()));
          },
        ),
        const SizedBox(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text('Added ${services.time} days ago',
