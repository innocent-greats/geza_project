...
import 'package:gezabeautyexpertapp/screens/messaging_screen.dart';
import 'package:gezabeautyexpertapp/screens/expert_invoice_screen.dart';
import 'package:gezabeautyexpertapp/class/url_launcher.dart';

class ServiceSummeryScreen extends StatefulWidget {
  final Request request;

  const ServiceSummeryScreen({super.key, required this.request});
  @override
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Text('25 August 2021', style: CustomStyle.textStyle),
            ],
          ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: Dimensions.heightSize),
          Text(
            '${Strings.addTip} ${widget.request.name}',
            style: TextStyle(
                color: Colors.black, fontSize: Dimensions.extraLargeTextSize),
          ),
          const SizedBox(
    ...
    return Positioned(
      ...
      child: GestureDetector(
        ...
        onTap: () {
          ...
          Navigator.of(context).push(MaterialPageRoute(
              builder: (context) => const ExpertInvoiceScreen()));
        },
      ),
    );
  }
